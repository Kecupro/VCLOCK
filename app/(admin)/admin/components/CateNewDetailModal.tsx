...
interface CategoryNewDetailModalProps {
  category: Category | null;
  onClose: () => void;
}

const CategoryNewDetailModal: React.FC<CategoryNewDetailModalProps> = ({ 
  category, 
  onClose, 
}) => {
...
export default CategoryNewDetailModal;